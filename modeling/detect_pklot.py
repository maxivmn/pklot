...
def detect_boxes(image):
    ...
    path_to_best_trained_model = '../runs/detect/train73/weights/best.pt'
    model = YOLO(path_to_best_trained_model)
...
def export_to_xml(prediction, display_output=False, testing=False, write_xml=True):
    ...
    root = ET.Element("parking", id='/Users/thisal_weerasekara/neuefische/pklot/data')
    contours = []
    labels = []
    id_counter = 1
    ...
    with open('../modeling/pages/output.xml', 'w') as f:
        f.write(xml_string)
...
if __name__ == "__main__":
    image_path ='/Users/thisal_weerasekara/neuefische/pklot/data/PKLot/PKLot/PUCPR/Cloudy/2012-09-12/2012-09-12_06_05_16.jpg'
