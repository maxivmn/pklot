...
if st.session_state.new_trigger is True:
    ...
    image_placeholder.image(cv2.cvtColor(image, cv2.COLOR_BGR2RGB), caption = 'Uploaded image', width=700)
    ...
    if st.session_state.button_clicked:
        ...
        image_placeholder_c = st.empty()
        image_placeholder_c.image(cv2.cvtColor(image_with_boxes, cv2.COLOR_BGR2RGB), caption = 'Detected boxes', width=700)
        ...
        # 2. Correction
            ...
            if remove:
                ...
                image_placeholder_c = st.empty()
                image_placeholder_c.image(cv2.cvtColor(image_with_removed_boxes, cv2.COLOR_BGR2RGB), caption = 'with deleted boxes', width=700)
        ...
        if st.session_state.correct:
            ...
            image_placeholder_c.image(cv2.cvtColor(image_out, cv2.COLOR_BGR2RGB), caption = 'Classified boxes', width= 700)
...
if st.session_state.old_trigger is True:
    ...
    image_placeholder_old.image(cv2.cvtColor(image, cv2.COLOR_BGR2RGB), caption = 'Uploaded image', width=700)
